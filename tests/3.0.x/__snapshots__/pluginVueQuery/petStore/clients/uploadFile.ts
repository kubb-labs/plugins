...
export function uploadFile<ThrowOnError extends boolean = true>(options: Options<UploadFileRequestConfig, ThrowOnError>): Promise<RequestResult<UploadFileResponses, ThrowOnError>> {
  ...
  return request({ method: 'POST', url: '/pet/{petId}/uploadImage', security: [{ type: 'oauth2' }], contentType: 'application/octet-stream', meta: { operationId: 'uploadFile', schemaPath: '/pet/{petId}/uploadImage' }, ...config }) as Promise<RequestResult<UploadFileResponses, ThrowOnError>>
}