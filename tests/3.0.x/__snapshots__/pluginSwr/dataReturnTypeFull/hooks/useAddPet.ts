...
export function useAddPet(options: {
  mutation?: SWRMutationConfiguration<ResponseConfig<AddPetResponse>, ResponseErrorConfig<AddPetStatus405>, AddPetMutationKey | null, AddPetMutationArg> & { throwOnError?: boolean },
