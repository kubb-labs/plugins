...
export function useGetOrderById(orderId?: GetOrderByIdPathOrderId, options: {
  query?: SWRConfiguration<ResponseConfig<GetOrderByIdResponse>, ResponseErrorConfig<GetOrderByIdStatus400 | GetOrderByIdStatus404>>,
  ...
  immutable?: boolean
         ...
         return useSWR<ResponseConfig<GetOrderByIdResponse>, ResponseErrorConfig<GetOrderByIdStatus400 | GetOrderByIdStatus404>, GetOrderByIdQueryKey | null>(
