 ...
 * {@link /pet/findByStatus}
 */
export function useFindPetsByStatusSuspense<TData = FindPetsByStatusResponse, TQueryKey extends QueryKey = FindPetsByStatusSuspenseQueryKey>({ params }: { params?: { status?: FindPetsByStatusQueryStatus } } = {}, options: {
