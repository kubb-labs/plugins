 ...
 * {@link /pet/findByStatus}
 */
export function useFindPetsByStatus<TData = FindPetsByStatusResponse, TQueryData = FindPetsByStatusResponse, TQueryKey extends QueryKey = FindPetsByStatusQueryKey>({ params }: { params?: { status?: FindPetsByStatusQueryStatus } } = {}, options: {
