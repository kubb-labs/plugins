 ...
 */
export async function getOrderByIdSuspense({ orderId }: { orderId: GetOrderByIdPathOrderId }, config: Partial<RequestConfig> & { client?: Client } = {}) {
 ...
 * {@link /store/order/:orderId}
 */
export function useGetOrderByIdSuspense<TData = GetOrderByIdResponse, TQueryKey extends QueryKey = GetOrderByIdSuspenseQueryKey>({ orderId }: { orderId: GetOrderByIdPathOrderId }, options: {
