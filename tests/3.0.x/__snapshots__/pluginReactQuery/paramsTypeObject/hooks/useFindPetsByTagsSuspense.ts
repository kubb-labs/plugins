 ...
 * {@link /pet/findByTags}
 */
export async function findPetsByTagsSuspense({ params }: { params?: { tags?: FindPetsByTagsQueryTags } } = {}, config: Partial<RequestConfig> & { client?: Client } = {}) {
 ...
 * {@link /pet/findByTags}
 */
export function useFindPetsByTagsSuspense<TData = FindPetsByTagsStatus200, TQueryKey extends QueryKey = FindPetsByTagsSuspenseQueryKey>({ params }: { params?: { tags?: FindPetsByTagsQueryTags } } = {}, options: {
