 ...
 * {@link /pet/findByTags}
 */
export function useFindPetsByTagsSuspense<TData = FindPetsByTagsResponse, TQueryKey extends QueryKey = FindPetsByTagsSuspenseQueryKey>({ params }: { params?: { tags?: FindPetsByTagsQueryTags } } = {}, options: {
