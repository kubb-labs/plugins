 ...
 * {@link /user/:username}
 */
export function useGetUserByName<TData = User, TQueryData = User, TQueryKey extends QueryKey = GetUserByNameQueryKey>(username: GetUserByNamePathUsername, options: {
