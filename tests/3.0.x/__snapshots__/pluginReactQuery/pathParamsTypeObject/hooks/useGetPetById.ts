 ...
 * {@link /pet/:petId}
 */
export function useGetPetById<TData = GetPetByIdResponse, TQueryData = GetPetByIdResponse, TQueryKey extends QueryKey = GetPetByIdQueryKey>({ petId }: { petId: GetPetByIdPathPetId }, options: {
