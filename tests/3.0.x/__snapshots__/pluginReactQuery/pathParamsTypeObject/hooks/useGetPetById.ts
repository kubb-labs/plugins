 ...
 * {@link /pet/:petId}
 */
export function useGetPetById<TData = Pet, TQueryData = Pet, TQueryKey extends QueryKey = GetPetByIdQueryKey>({ petId }: { petId: GetPetByIdPathPetId }, options: {
  query?: Partial<QueryObserverOptions<Pet, ResponseErrorConfig<GetPetByIdStatus400 | GetPetByIdStatus404>, TData, TQueryData, TQueryKey>> & { client?: QueryClient },
