 ...
 * {@link /store/order/:orderId}
 */
export function useGetOrderById<TData = GetOrderByIdResponse, TQueryData = GetOrderByIdResponse, TQueryKey extends QueryKey = GetOrderByIdQueryKey>({ orderId }: { orderId: GetOrderByIdPathOrderId }, options: {
