...
/**
   ...
   */
    ...
    return request({ method: 'POST', url: '/pet', security: [{ type: 'oauth2' }], meta: { operationId: 'addPet', schemaPath: '/pet' }, ...config }) as Promise<RequestResult<AddPetResponses, ThrowOnError>>
  }
...
/**
   ...
   */
    ...
    return request({ method: 'GET', url: '/pet/findByStatus', security: [{ type: 'oauth2' }], meta: { operationId: 'findPetsByStatus', schemaPath: '/pet/findByStatus' }, ...config }) as Promise<RequestResult<FindPetsByStatusResponses, ThrowOnError>>
  }
...
/**
   ...
   */
    ...
    return request({ method: 'GET', url: '/pet/{petId}', security: [{ type: 'apiKey', name: 'api_key', in: 'header' }, { type: 'oauth2' }], meta: { operationId: 'getPetById', schemaPath: '/pet/{petId}' }, ...config }) as Promise<RequestResult<GetPetByIdResponses, ThrowOnError>>
  }
...
/**
   ...
   */
    ...
    return request({ method: 'DELETE', url: '/pet/{petId}', security: [{ type: 'oauth2' }], meta: { operationId: 'deletePet', schemaPath: '/pet/{petId}' }, ...config }) as Promise<RequestResult<DeletePetResponses, ThrowOnError>>
  }
...
/**
   ...
   */
    ...
    return request({ method: 'POST', url: '/pet/{petId}/uploadImage', security: [{ type: 'oauth2' }], meta: { operationId: 'uploadFile', schemaPath: '/pet/{petId}/uploadImage' }, ...config }) as Promise<RequestResult<UploadFileResponses, ThrowOnError>>
  }
