 ...
 * {@link /user/:username}
 */
export async function updateUserHandler({ username, data }: { username: UpdateUserPathUsername; data?: UpdateUserData }, request: RequestHandlerExtra): Promise<Promise<CallToolResult>> {
