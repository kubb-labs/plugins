...
export async function addPetHandler({ data }: { data: AddPetData }): Promise<Promise<CallToolResult>> {
  ...
  const res = await fetch<AddPetResponse, ResponseErrorConfig<AddPetStatus405>, AddPetData>({ method: "POST", url: `/pet`, baseURL: `https://petstore.swagger.io/v2`, data: requestData })
