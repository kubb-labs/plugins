...
import { createPetsDataSchema, createPetsHeaderXEXAMPLESchema, createPetsPathUuidSchema, createPetsQueryOffsetSchema, createPetsStatus201Schema } from "../zod/createPetsSchema.js";
...
import { findPetsByTagsHeaderXEXAMPLESchema, findPetsByTagsQueryPageSchema, findPetsByTagsQueryPageSizeSchema, findPetsByTagsQueryTagsSchema, findPetsByTagsStatus200Schema } from "../zod/findPetsByTagsSchema.js";
...
server.registerTool("createPets", {
  ...
  inputSchema: { uuid: createPetsPathUuidSchema, data: createPetsDataSchema, headers: z.object({ "X-EXAMPLE": createPetsHeaderXEXAMPLESchema }), params: z.object({ "offset": createPetsQueryOffsetSchema }) },
...
server.registerTool("findPetsByTags", {
  ...
  inputSchema: { headers: z.object({ "X-EXAMPLE": findPetsByTagsHeaderXEXAMPLESchema }), params: z.object({ "tags": findPetsByTagsQueryTagsSchema, "page": findPetsByTagsQueryPageSchema, "pageSize": findPetsByTagsQueryPageSizeSchema }) },
...
server.registerTool("placeOrderPatch", {
