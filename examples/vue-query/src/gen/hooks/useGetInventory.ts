...
export function useGetInventory<TData = GetInventoryQueryResponse, TQueryData = GetInventoryQueryResponse, TQueryKey extends QueryKey = GetInventoryQueryKey>(options: 
{
 ...
 = {}) {
         ...
         const query = useQuery({
          ...
          ...resolvedOptions,
          queryKey
         } as unknown as UseQueryOptions<GetInventoryQueryResponse, ResponseErrorConfig<Error>, TData, GetInventoryQueryResponse, TQueryKey>, toValue(queryClient)) as UseQueryReturnType<TData, ResponseErrorConfig<Error>> & { queryKey: TQueryKey }
