...
export function usePlaceOrderPatch<TContext>(options: {
  mutation?: MutationObserverOptions<PlaceOrderPatchStatus200, ResponseErrorConfig<PlaceOrderPatchStatus405>, PlaceOrderPatchRequestConfig, TContext> & { client?: QueryClient },
