...
export function useLogoutUser<TData = LogoutUserQueryResponse, TQueryData = LogoutUserQueryResponse, TQueryKey extends QueryKey = LogoutUserQueryKey>(options: 
{
 ...
 = {}) {
         ...
         const query = useQuery({
          ...
          ...resolvedOptions,
          queryKey
         } as unknown as UseQueryOptions<LogoutUserQueryResponse, ResponseErrorConfig<Error>, TData, LogoutUserQueryResponse, TQueryKey>, toValue(queryClient)) as UseQueryReturnType<TData, ResponseErrorConfig<Error>> & { queryKey: TQueryKey }
