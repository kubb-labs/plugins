 ...
 */
export async function uploadFile({ petId }: { petId: UploadFilePathParams["petId"] }, data?: UploadFileMutationRequest, params?: UploadFileQueryParams, config: Partial<RequestConfig<UploadFileMutationRequest>> & { client?: Client } = {}) {
