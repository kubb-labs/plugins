...
export function useLoginUser<TData = LoginUserQueryResponse, TQueryData = LoginUserQueryResponse, TQueryKey extends QueryKey = LoginUserQueryKey>(params?: MaybeRefOrGetter<LoginUserQueryParams>, options: 
{
 ...
 = {}) {
         ...
         const query = useQuery({
          ...
          ...resolvedOptions,
          queryKey
         } as unknown as UseQueryOptions<LoginUserQueryResponse, ResponseErrorConfig<LoginUser400>, TData, LoginUserQueryResponse, TQueryKey>, toValue(queryClient)) as UseQueryReturnType<TData, ResponseErrorConfig<LoginUser400>> & { queryKey: TQueryKey }
