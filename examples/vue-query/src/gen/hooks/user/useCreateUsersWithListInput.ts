...
export function useCreateUsersWithListInput<TContext>(options: {
  mutation?: MutationObserverOptions<CreateUsersWithListInputStatus200, ResponseErrorConfig<Error>, CreateUsersWithListInputRequestConfig, TContext> & { client?: QueryClient },
