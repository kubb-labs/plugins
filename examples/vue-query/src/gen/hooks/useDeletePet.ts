...
export function useDeletePet<TContext>(options: {
  mutation?: MutationObserverOptions<DeletePetResponse, ResponseErrorConfig<DeletePetStatus400>, {petId: MaybeRefOrGetter<DeletePetPathPetId>, headers?: MaybeRefOrGetter<unknown>}, TContext> & { client?: QueryClient },
