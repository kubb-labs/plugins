...
export const findPetsByStatusQueryKey = (params?: { status?: FindPetsByStatusQueryStatus }) => ["v5", { url: '/pet/findByStatus' }, ...(params ? [params] : [])] as const
 ...
 * {@link /pet/findByStatus}
 */
export function useFindPetsByStatusHook<TData = FindPetsByStatusResponse, TQueryData = FindPetsByStatusResponse, TQueryKey extends QueryKey = FindPetsByStatusQueryKey>(params?: { status?: FindPetsByStatusQueryStatus }, options: {
