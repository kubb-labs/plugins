...
export const findPetsByStatusSuspenseQueryKey = (params?: { status?: FindPetsByStatusQueryStatus }) => ["v5", { url: '/pet/findByStatus' }, ...(params ? [params] : [])] as const
 ...
 */
export async function findPetsByStatusSuspenseHook(params?: { status?: FindPetsByStatusQueryStatus }, config: Partial<RequestConfig> & { client?: Client } = {}) {
...
export function findPetsByStatusSuspenseQueryOptionsHook(params?: { status?: FindPetsByStatusQueryStatus }, config: Partial<RequestConfig> & { client?: Client } = {}) {
 ...
 * {@link /pet/findByStatus}
 */
export function useFindPetsByStatusSuspenseHook<TData = FindPetsByStatusResponse, TQueryKey extends QueryKey = FindPetsByStatusSuspenseQueryKey>(params?: { status?: FindPetsByStatusQueryStatus }, options: {
