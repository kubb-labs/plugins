 ...
 * {@link /user/:username}
 */
export async function updateUserHook({ username }: { username: UpdateUserPathUsername }, data?: UpdateUserData, config: Partial<RequestConfig<UpdateUserData>> & { client?: Client } = {}) {
 ...
 * {@link /user/:username}
 */
export function useUpdateUserHook<TContext>(options: {
  ...
  client?: Partial<RequestConfig<UpdateUserData>> & { client?: Client },
          ...
          const baseOptions = updateUserMutationOptionsHook(config) as UseMutationOptions<UpdateUserResponse, ResponseErrorConfig<Error>, {username: UpdateUserPathUsername, data?: UpdateUserData}, TContext>
          const customOptions = useCustomHookOptions({ hookName: 'useUpdateUserHook', operationId: 'updateUser' }) as UseMutationOptions<UpdateUserResponse, ResponseErrorConfig<Error>, {username: UpdateUserPathUsername, data?: UpdateUserData}, TContext>
