 ...
 * {@link /user/logout}
 */
export function useLogoutUserSuspenseHook<TData = LogoutUserResponse, TQueryKey extends QueryKey = LogoutUserSuspenseQueryKey>(options: {
  ...
  client?: Partial<RequestConfig> & { client?: Client }
         ...
         const customOptions = useCustomHookOptions({ hookName: 'useLogoutUserSuspenseHook', operationId: 'logoutUser' })
