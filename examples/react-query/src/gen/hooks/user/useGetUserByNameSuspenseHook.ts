...
export const getUserByNameSuspenseQueryKey = ({ username }: { username: GetUserByNamePathUsername }) => ["v5", { url: '/user/:username', params: {username:username} }] as const
 ...
 * {@link /user/:username}
 */
export async function getUserByNameSuspenseHook({ username }: { username: GetUserByNamePathUsername }, config: Partial<RequestConfig> & { client?: Client } = {}) {
...
export function getUserByNameSuspenseQueryOptionsHook({ username }: { username: GetUserByNamePathUsername }, config: Partial<RequestConfig> & { client?: Client } = {}) {
 ...
 * {@link /user/:username}
 */
export function useGetUserByNameSuspenseHook<TData = GetUserByNameResponse, TQueryKey extends QueryKey = GetUserByNameSuspenseQueryKey>({ username }: { username: GetUserByNamePathUsername }, options: {
