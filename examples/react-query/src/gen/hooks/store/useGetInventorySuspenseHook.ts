...
export function getInventorySuspenseQueryOptionsHook(config: Partial<RequestConfig> & { client?: Client } = {}) {
 ...
 * {@link /store/inventory}
 */
export function useGetInventorySuspenseHook<TData = GetInventoryResponse, TQueryKey extends QueryKey = GetInventorySuspenseQueryKey>(options: {
