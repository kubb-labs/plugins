 ...
 * {@link /store/order/:orderId}
 */
export function useDeleteOrderHook<TContext>(options: {
  ...
  client?: Partial<RequestConfig> & { client?: Client },
          ...
          const baseOptions = deleteOrderMutationOptionsHook(config) as UseMutationOptions<DeleteOrderResponse, ResponseErrorConfig<DeleteOrderStatus400 | DeleteOrderStatus404>, {orderId: DeleteOrderPathOrderId}, TContext>
          const customOptions = useCustomHookOptions({ hookName: 'useDeleteOrderHook', operationId: 'deleteOrder' }) as UseMutationOptions<DeleteOrderResponse, ResponseErrorConfig<DeleteOrderStatus400 | DeleteOrderStatus404>, {orderId: DeleteOrderPathOrderId}, TContext>
