...
import type { AddPetData, AddPetResponse, AddPetStatus405, UpdatePetData, UpdatePetResponse, UpdatePetStatus400, UpdatePetStatus404, UpdatePetStatus405, FindPetsByStatusResponse, FindPetsByStatusQueryStatus, FindPetsByStatusStatus400, FindPetsByTagsResponse, FindPetsByTagsQueryTags, FindPetsByTagsQueryPage, FindPetsByTagsQueryPageSize, FindPetsByTagsStatus400, GetPetByIdResponse, GetPetByIdPathPetId, GetPetByIdStatus400, GetPetByIdStatus404, UpdatePetWithFormResponse, UpdatePetWithFormPathPetId, UpdatePetWithFormQueryName, UpdatePetWithFormQueryStatus, UpdatePetWithFormStatus405, DeletePetResponse, DeletePetPathPetId, DeletePetHeaderApiKey, DeletePetStatus400, UploadFileData, UploadFileResponse, UploadFilePathPetId, UploadFileQueryAdditionalMetadata, GetInventoryResponse, PlaceOrderData, PlaceOrderResponse, PlaceOrderStatus405, PlaceOrderPatchData, PlaceOrderPatchResponse, PlaceOrderPatchStatus405, GetOrderByIdResponse, GetOrderByIdPathOrderId, GetOrderByIdStatus400, GetOrderByIdStatus404, DeleteOrderResponse, DeleteOrderPathOrderId, DeleteOrderStatus400, DeleteOrderStatus404, CreateUserData, CreateUserResponse, CreateUsersWithListInputData, CreateUsersWithListInputResponse, LoginUserResponse, LoginUserQueryUsername, LoginUserQueryPassword, LoginUserStatus400, LogoutUserResponse, GetUserByNameResponse, GetUserByNamePathUsername, GetUserByNameStatus400, GetUserByNameStatus404, UpdateUserData, UpdateUserResponse, UpdateUserPathUsername, DeleteUserResponse, DeleteUserPathUsername, DeleteUserStatus400, DeleteUserStatus404 } from "./models";
import type { Client, RequestConfig, ResponseErrorConfig } from "@kubb/plugin-client/clients/axios";
import type { QueryKey, QueryClient, QueryObserverOptions, UseQueryResult, UseMutationOptions, UseMutationResult, UseSuspenseQueryOptions, UseSuspenseQueryResult } from "@tanstack/react-query";
...
export function findPetsByTagsQueryOptions(params?: { tags?: FindPetsByTagsQueryTags; page?: FindPetsByTagsQueryPage; pageSize?: FindPetsByTagsQueryPageSize }, config: Partial<RequestConfig> & { client?: Client } = {}) {
 ...
 * {@link /pet/findByTags}
 */
export function useFindPetsByTags<TData = FindPetsByTagsResponse, TQueryData = FindPetsByTagsResponse, TQueryKey extends QueryKey = FindPetsByTagsQueryKey>(params?: { tags?: FindPetsByTagsQueryTags; page?: FindPetsByTagsQueryPage; pageSize?: FindPetsByTagsQueryPageSize }, options: {
...
export const findPetsByTagsSuspenseQueryKey = (params?: { tags?: FindPetsByTagsQueryTags; page?: FindPetsByTagsQueryPage; pageSize?: FindPetsByTagsQueryPageSize }) => [{ url: '/pet/findByTags' }, ...(params ? [params] : [])] as const
 ...
 * {@link /pet/findByTags}
 */
export async function findPetsByTagsSuspense(params?: { tags?: FindPetsByTagsQueryTags; page?: FindPetsByTagsQueryPage; pageSize?: FindPetsByTagsQueryPageSize }, config: Partial<RequestConfig> & { client?: Client } = {}) {
  const { client: request = fetch, ...requestConfig } = config
...
export function findPetsByTagsSuspenseQueryOptions(params?: { tags?: FindPetsByTagsQueryTags; page?: FindPetsByTagsQueryPage; pageSize?: FindPetsByTagsQueryPageSize }, config: Partial<RequestConfig> & { client?: Client } = {}) {
 ...
 * {@link /pet/findByTags}
 */
export function useFindPetsByTagsSuspense<TData = FindPetsByTagsResponse, TQueryKey extends QueryKey = FindPetsByTagsSuspenseQueryKey>(params?: { tags?: FindPetsByTagsQueryTags; page?: FindPetsByTagsQueryPage; pageSize?: FindPetsByTagsQueryPageSize }, options: {
...
export async function placeOrderPatch(data?: PlaceOrderPatchData, config: Partial<RequestConfig<PlaceOrderPatchData>> & { client?: Client } = {}) {
  ...
  const res = await request<PlaceOrderPatchResponse, ResponseErrorConfig<PlaceOrderPatchStatus405>, PlaceOrderPatchData>({ method: "PATCH", url: `/store/order`, data: requestData, ...requestConfig })
...
export function usePlaceOrderPatch<TContext>(options: {
  mutation?: UseMutationOptions<PlaceOrderPatchResponse, ResponseErrorConfig<PlaceOrderPatchStatus405>, {data?: PlaceOrderPatchData}, TContext> & { client?: QueryClient },
  client?: Partial<RequestConfig<PlaceOrderPatchData>> & { client?: Client },
          ...
          const baseOptions = placeOrderPatchMutationOptions(config) as UseMutationOptions<PlaceOrderPatchResponse, ResponseErrorConfig<PlaceOrderPatchStatus405>, {data?: PlaceOrderPatchData}, TContext>
          ...
          return useMutation<PlaceOrderPatchResponse, ResponseErrorConfig<PlaceOrderPatchStatus405>, {data?: PlaceOrderPatchData}, TContext>({
            ...
            mutationKey,
            ...mutationOptions,
          }, queryClient) as UseMutationResult<PlaceOrderPatchResponse, ResponseErrorConfig<PlaceOrderPatchStatus405>, {data?: PlaceOrderPatchData}, TContext>
 ...
 * {@link /user/login}
 */
export function useLoginUser<TData = LoginUserResponse, TQueryData = LoginUserResponse, TQueryKey extends QueryKey = LoginUserQueryKey>(params?: { username?: LoginUserQueryUsername; password?: LoginUserQueryPassword }, options: {
