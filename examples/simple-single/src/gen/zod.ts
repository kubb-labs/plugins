...
export const orderSchema = z.object({
    ...
    "http_status": z.union([z.literal(200), z.literal(400), z.literal(500)]).optional().describe("HTTP Status's and item of this"),
...
export const userSchema = personSchema.and(z.object({
    "id": z.int().optional(),
    "username": z.string().optional(),
