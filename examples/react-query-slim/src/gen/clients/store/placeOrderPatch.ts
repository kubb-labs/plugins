 ...
 * {@link /store/order}
 */
export function placeOrderPatch<ThrowOnError extends boolean = true>(options: Options<PlaceOrderPatchRequestConfig, ThrowOnError>): Promise<RequestResult<PlaceOrderPatchResponses, ThrowOnError>> {
