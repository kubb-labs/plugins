 ...
 */
export function getOrderById<ThrowOnError extends boolean = true>(options: Options<GetOrderByIdRequestConfig, ThrowOnError>): Promise<RequestResult<GetOrderByIdResponses, ThrowOnError>> {
