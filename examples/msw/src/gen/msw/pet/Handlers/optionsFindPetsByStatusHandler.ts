...
export function optionsFindPetsByStatusHandler(data?: OptionsFindPetsByStatusResponse | ((info: Parameters<Parameters<typeof http.options>[1]>[0]) => Response | Promise<Response>)) {
