 ...
 */
export function deleteOrder<ThrowOnError extends boolean = true>(options: Options<DeleteOrderRequestConfig, ThrowOnError>): Promise<RequestResult<DeleteOrderResponses, ThrowOnError>> {
