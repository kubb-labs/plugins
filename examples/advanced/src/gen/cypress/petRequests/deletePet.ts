...
export function deletePet(petId: DeletePetPathPetId, headers?: { apiKey?: DeletePetHeaderApiKey }, options: Partial<Cypress.RequestOptions> = {}): Cypress.Chainable<DeletePetResponse> {
