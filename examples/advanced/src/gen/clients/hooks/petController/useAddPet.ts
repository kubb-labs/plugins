...
export function useAddPet<TContext>(options: {
  mutation?: UseMutationOptions<ResponseConfig<AddPetResponse>, ResponseErrorConfig<AddPetStatus405>, {data: AddPetData}, TContext> & { client?: QueryClient },
  client?: Partial<RequestConfig<AddPetData>> & { client?: Client },
          ...
          const baseOptions = addPetMutationOptions(config) as UseMutationOptions<ResponseConfig<AddPetResponse>, ResponseErrorConfig<AddPetStatus405>, {data: AddPetData}, TContext>
          ...
          return useMutation<ResponseConfig<AddPetResponse>, ResponseErrorConfig<AddPetStatus405>, {data: AddPetData}, TContext>({
            ...
            mutationKey,
            ...mutationOptions,
          }, queryClient) as UseMutationResult<ResponseConfig<AddPetResponse>, ResponseErrorConfig<AddPetStatus405>, {data: AddPetData}, TContext>
