...
export function getPetByIdQueryOptions({ petId }: { petId: GetPetByIdPathPetId }, config: Partial<RequestConfig> & { client?: Client } = {}) {
        ...
        return queryOptions<ResponseConfig<GetPetByIdResponse>, ResponseErrorConfig<GetPetByIdStatus400 | GetPetByIdStatus404>, ResponseConfig<GetPetByIdResponse>, typeof queryKey>({
         enabled: !!(petId),
         queryKey,
 ...
 */
export function useGetPetById<TData = ResponseConfig<GetPetByIdResponse>, TQueryData = ResponseConfig<GetPetByIdResponse>, TQueryKey extends QueryKey = GetPetByIdQueryKey>({ petId }: { petId: GetPetByIdPathPetId }, options: {
  query?: Partial<QueryObserverOptions<ResponseConfig<GetPetByIdResponse>, ResponseErrorConfig<GetPetByIdStatus400 | GetPetByIdStatus404>, TData, TQueryData, TQueryKey>> & { client?: QueryClient },
