 ...
 * {@link /user/login}
 */
export function useLoginUser<TData = ResponseConfig<LoginUserResponse>, TQueryData = ResponseConfig<LoginUserResponse>, TQueryKey extends QueryKey = LoginUserQueryKey>({ params }: { params?: { username?: LoginUserQueryUsername; password?: LoginUserQueryPassword } } = {}, options: {
  query?: Partial<QueryObserverOptions<ResponseConfig<LoginUserResponse>, ResponseErrorConfig<LoginUserStatus400>, TData, TQueryData, TQueryKey>> & { client?: QueryClient },
