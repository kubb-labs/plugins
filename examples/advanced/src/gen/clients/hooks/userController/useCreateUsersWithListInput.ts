...
export function useCreateUsersWithListInput<TContext>(options: {
  mutation?: UseMutationOptions<ResponseConfig<CreateUsersWithListInputResponse>, ResponseErrorConfig<Error>, {data?: CreateUsersWithListInputData}, TContext> & { client?: QueryClient },
  client?: Partial<RequestConfig<CreateUsersWithListInputData>> & { client?: Client },
          ...
          const baseOptions = createUsersWithListInputMutationOptions(config) as UseMutationOptions<ResponseConfig<CreateUsersWithListInputResponse>, ResponseErrorConfig<Error>, {data?: CreateUsersWithListInputData}, TContext>
          ...
          return useMutation<ResponseConfig<CreateUsersWithListInputResponse>, ResponseErrorConfig<Error>, {data?: CreateUsersWithListInputData}, TContext>({
            ...
            mutationKey,
            ...mutationOptions,
          }, queryClient) as UseMutationResult<ResponseConfig<CreateUsersWithListInputResponse>, ResponseErrorConfig<Error>, {data?: CreateUsersWithListInputData}, TContext>
