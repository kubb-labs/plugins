...
export function useUpdateUser<TContext>(options: {
  mutation?: UseMutationOptions<ResponseConfig<UpdateUserResponse>, ResponseErrorConfig<Error>, {username: UpdateUserPathUsername, data?: UpdateUserData}, TContext> & { client?: QueryClient },
  client?: Partial<RequestConfig<UpdateUserData>> & { client?: Client },
          ...
          const baseOptions = updateUserMutationOptions(config) as UseMutationOptions<ResponseConfig<UpdateUserResponse>, ResponseErrorConfig<Error>, {username: UpdateUserPathUsername, data?: UpdateUserData}, TContext>
          ...
          return useMutation<ResponseConfig<UpdateUserResponse>, ResponseErrorConfig<Error>, {username: UpdateUserPathUsername, data?: UpdateUserData}, TContext>({
            ...
            mutationKey,
            ...mutationOptions,
          }, queryClient) as UseMutationResult<ResponseConfig<UpdateUserResponse>, ResponseErrorConfig<Error>, {username: UpdateUserPathUsername, data?: UpdateUserData}, TContext>
