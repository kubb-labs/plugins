...
import type { GetUserByNamePathUsername, GetUserByNameResponse, GetUserByNameStatus400, GetUserByNameStatus404 } from "../../../models/ts/userController/GetUserByName.ts";
