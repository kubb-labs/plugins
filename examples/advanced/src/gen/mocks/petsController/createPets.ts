import type { CreatePetsData, CreatePetsHeaderXEXAMPLE, CreatePetsQueryBoolParam, CreatePetsResponse, CreatePetsStatusDefault } from "../../models/ts/petsController/CreatePets.ts";
