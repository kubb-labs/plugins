...
import { findPetsByTagsHeaderXEXAMPLESchema, findPetsByTagsQueryPageSchema, findPetsByTagsQueryPageSizeSchema, findPetsByTagsQueryTagsSchema, findPetsByTagsStatus200Schema } from "../zod/petController/findPetsByTagsSchema.ts";
...
import { updatePetWithFormPathPetIdSchema, updatePetWithFormQueryNameSchema, updatePetWithFormQueryStatusSchema } from "../zod/petController/updatePetWithFormSchema.ts";
import { uploadFileDataSchema, uploadFilePathPetIdSchema, uploadFileQueryAdditionalMetadataSchema, uploadFileStatus200Schema } from "../zod/petController/uploadFileSchema.ts";
import { createPetsDataSchema, createPetsHeaderXEXAMPLESchema, createPetsPathUuidSchema, createPetsQueryBoolParamSchema, createPetsQueryOffsetSchema, createPetsStatus201Schema } from "../zod/petsController/createPetsSchema.ts";
...
server.registerTool("createPets", {
  title: "Create a pet",
  description: "Make a POST request to /pets/{uuid}",
  outputSchema: { data: createPetsStatus201Schema },
  inputSchema: { uuid: createPetsPathUuidSchema, data: createPetsDataSchema, headers: z.object({ "xEXAMPLE": createPetsHeaderXEXAMPLESchema }), params: z.object({ "boolParam": createPetsQueryBoolParamSchema, "offset": createPetsQueryOffsetSchema }) },
...
server.registerTool("findPetsByTags", {
  ...
  inputSchema: { headers: z.object({ "xEXAMPLE": findPetsByTagsHeaderXEXAMPLESchema }), params: z.object({ "tags": findPetsByTagsQueryTagsSchema, "page": findPetsByTagsQueryPageSchema, "pageSize": findPetsByTagsQueryPageSizeSchema }) },
