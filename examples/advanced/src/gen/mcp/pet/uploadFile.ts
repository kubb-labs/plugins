...
export async function uploadFileHandler(
  ...
  const res = await client<UploadFileResponse, ResponseErrorConfig<Error>, unknown>(
    { method: 'POST', url: `/pet/${petId}/uploadImage`, baseURL: `https://petstore.swagger.io/v2`, params },
    request,
  )
