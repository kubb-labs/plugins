...
- [#588](https://github.com/kubb-labs/plugins/pull/588) [`5e03a70`](https://github.com/kubb-labs/plugins/commit/5e03a70f44c845e4230ca64665db4fdc226af746) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - Emit strict-typecheck-clean Zod for several real-world spec edge cases:
...
- [#421](https://github.com/kubb-labs/plugins/pull/421) [`1d58e1a`](https://github.com/kubb-labs/plugins/commit/1d58e1a6bf6514930bb8bbb214c6435bcb608530) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - Fix optional ref properties not being wrapped in `.optional()` (or `z.optional()` in mini mode) inside `z.object()`. Properties declared with `required: false` were emitted without the optional modifier because the printers checked `schema.optional` instead of `property.required`.
...
- [#79](https://github.com/kubb-labs/plugins/pull/79) [`dd9c91a`](https://github.com/kubb-labs/plugins/commit/dd9c91a7c4deba02b6751e9965455674bfacc703) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - Fix unreachable code in getter when discriminator property overrides external schema with description.
  ...
  Fixes [#15](https://github.com/kubb-labs/plugins/issues/15)
