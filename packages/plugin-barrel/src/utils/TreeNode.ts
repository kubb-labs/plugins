 ...
 * flat list of generated {@link ast.FileNode} entries.
 *
...
export class TreeNode {
   ...
   */
  public static build(files: ast.FileNode[], root?: string): TreeNode | null {
    try {
...
function buildDirectoryTree(files: Array<ast.FileNode>, rootFolder = ''): DirectoryTree | null {
