...
import { buildParserHooks, buildZodErrorParse, getOperationSecurity, Operation, resolveRequestParser, resolveResponseParser, type SecurityDocument } from '@internals/client'
  ...
  operation(node, ctx) {
    ...
    return (
      ...
      >
        ...
        {parserHooks.needsValidateHelper && (
          <File.Import name={['validateStandardSchema']} root={meta.file.path} path={standardSchemaPath} />
        )}
