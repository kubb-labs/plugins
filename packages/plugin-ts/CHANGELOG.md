...
- [#710](https://github.com/kubb-labs/plugins/pull/710) [`369e4cd`](https://github.com/kubb-labs/plugins/commit/369e4cd22e37644bb671429a6bdf18c12b39d76e) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - Omit the `@type` JSDoc tag when it would be the only content of a comment block, since it just repeats the TypeScript type already next to the property.
...
- [#568](https://github.com/kubb-labs/plugins/pull/568) [`e20770b`](https://github.com/kubb-labs/plugins/commit/e20770b6baf5f5274e3dd8005a06580787274e3e) Thanks [@Ericlm](https://github.com/Ericlm)! - Honor resolveTypeName when printing TypeScript schema references.
...
- [#424](https://github.com/kubb-labs/plugins/pull/424) [`058c7ff`](https://github.com/kubb-labs/plugins/commit/058c7ffe6d8959c718543782f95d4f7bbef1cbe7) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - Fix empty string enum values being dropped from generated TypeScript types.

  OpenAPI enums containing `""` (empty string) were silently omitted from the emitted
  TypeScript type in all enum modes (`asConst`, `literal`, `inlineLiteral`, `enum`,
  `constEnum`). The Zod plugin already handled empty strings correctly, causing a
...
- [#230](https://github.com/kubb-labs/plugins/pull/230) [`21accf1`](https://github.com/kubb-labs/plugins/commit/21accf11be058a252aded049a5d98e30eb6b4c32) Thanks [@Ericlm](https://github.com/Ericlm)! - Add format info into description of generated fields
...
- Updated dependencies [[`4cfcb62`](https://github.com/kubb-labs/kubb/commit/4cfcb6290ffa11c93f19345c93906af65ec18339), [`4cfcb62`](https://github.com/kubb-labs/kubb/commit/4cfcb6290ffa11c93f19345c93906af65ec18339), [`4cfcb62`](https://github.com/kubb-labs/kubb/commit/4cfcb6290ffa11c93f19345c93906af65ec18339)]:
...
- [#2637](https://github.com/kubb-labs/kubb/pull/2637) [`4e151b7`](https://github.com/kubb-labs/kubb/commit/4e151b7182393d870d51fe5377610e05928ccf14) Thanks [@copilot-swe-agent](https://github.com/apps/copilot-swe-agent)! - Fix barrel file exporting non-existent runtime `const` when an enum schema is empty.
...
- [#2486](https://github.com/kubb-labs/kubb/pull/2486) [`d260f9a`](https://github.com/kubb-labs/kubb/commit/d260f9a1f8a24ad2f1999fbdb918bb47cca078d0) Thanks [@Ericlm](https://github.com/Ericlm)! - Make the `title` property of the schema the main comment in generated types.
...
- [#2444](https://github.com/kubb-labs/kubb/pull/2444) [`9592063`](https://github.com/kubb-labs/kubb/commit/9592063f91bf9d3604b508774fb7d8f7a09e47f8) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - Upgrade fabric
...
- Updated dependencies [[`c3c210f`](https://github.com/kubb-labs/kubb/commit/c3c210f48c061a0612aec0a8f3f12cd9e50f4483)]:
...
- [`208da32`](https://github.com/kubb-labs/kubb/commit/208da32045557dbb32a739ea0031d67848e59928) Thanks [@stijnvanhullem](https://github.com/stijnvanhullem)! - nullable: true now generates | null union
...
- [`4d5f8d3`](https://github.com/kubb-labs/kubb/commit/4d5f8d3dae94e2cbe82fbbb6578532bdf41bee0d) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - Exporting 'enum' as 'type' without export type
...
- Updated dependencies [[`622073d`](https://github.com/kubb-labs/kubb/commit/622073d5223180f0945ef0919dc3df841359019f)]:
...
- [#851](https://github.com/kubb-labs/kubb/pull/851) [`e2eed44`](https://github.com/kubb-labs/kubb/commit/e2eed4482e2e49d41c87e64eb484ebedbeb3ccc8) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - use of `enumSuffix`
...
- [`96461a6`](https://github.com/kubb-labs/kubb/commit/96461a6028d5be9cf0903d3729fd6153185092c2) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - remove namespace for mutations
...
- [#793](https://github.com/kubb-labs/kubb/pull/793) [`3e46f03`](https://github.com/kubb-labs/kubb/commit/3e46f031e4d54ea2cb197446c5922280b09326d5) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - Remove use of namespace

- Updated dependencies [[`bf1e521`](https://github.com/kubb-labs/kubb/commit/bf1e52182b636cef8c2cd54bcb123baf47d2d624), [`e9aaa92`](https://github.com/kubb-labs/kubb/commit/e9aaa92b891971d22cbb19f4a1bd37edbdc8bd7d)]:
  - @kubb/core@2.4.1
  - @kubb/swagger@2.4.1
  - @kubb/react@2.4.1
  - @kubb/parser@2.4.1
...
- [`37bd469`](https://github.com/kubb-labs/kubb/commit/37bd469acbe1b80b9602621c8c128b1b0d456d21) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - include export of enums instead of types only(`export *` instead of `export type *`)
