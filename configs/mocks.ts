...
import type { FileNode, OperationNode, SchemaNode, Visitor } from '@kubb/ast/types'
import type {
  Adapter,
...
import { FileManager } from '@kubb/core/src/FileManager.ts'
import { FileProcessor } from '@kubb/core/src/FileProcessor.ts'
import { applyHookResult } from '@kubb/core/src/renderNode.tsx'
